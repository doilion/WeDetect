...
def main():
    # 加载配置和模型
    cfg = Config.fromfile('config/wedetect_tiny_tct.py')
    ...
    # 加载 novel 测试集
    ann_file = '/root/datasets/TCT_NGC/annotations/test_novel_v2.json'
    ...
    for img_id in tqdm(img_ids):
        ...
        img_path = f"/root/datasets/TCT_NGC/{img_info['file_name']}"
    ...
    # 保存预测结果
    pred_file = 'work_dirs/test_novel/novel_predictions.json'
    import os
    os.makedirs('work_dirs/test_novel', exist_ok=True)

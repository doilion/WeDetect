...
def main():
    # 加载配置和模型
    cfg = Config.fromfile('config/wedetect_tiny_tct_exp2.py')
    checkpoint = 'work_dirs/wedetect_tiny_tct_exp2/best_coco_bbox_mAP_epoch_8.pth'
    ...
    # 保存预测结果
    pred_file = 'work_dirs/test_novel_exp2/novel_predictions.json'
    import os
    os.makedirs('work_dirs/test_novel_exp2', exist_ok=True)

...
# ======================= 实验5: 英文全称文本描述 =======================
# 目的: 验证使用英文全称+多别名对检测性能的影响 (对比 exp3)
# 基础配置: exp3 (Loss调整: cls=1.0, bbox=5.0)

data_root = "/home1/liwenjie/TCT_NGC/"
train_class_text_path = "data/texts/tct_ngc_v2_base_class_texts_en.json"
test_class_text_path = "data/texts/tct_ngc_v2_class_texts_en.json"
...
work_dir = './work_dirs/wedetect_tiny_tct_exp5'

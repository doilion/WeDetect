...
max_epochs = 20                     # Experiment 1: longer training with lower lr
close_mosaic_epochs = 2
save_epoch_intervals = 1
text_channels = 768
neck_embed_channels = [128, 256, 512]
neck_num_heads = [4, 8, 16]
base_lr = 1e-4                      # Experiment 1: reduced from 2e-4 for smoother convergence
weight_decay = 0.05                 # Increased for stronger regularization
train_batch_size_per_gpu = 28       # Increased to better utilize 49GB GPU
...
tal_topk = 10
tal_alpha = 0.5
tal_beta = 2.0  # Reduced for better positive sample assignment
loss_cls_weight = 0.5
...
val_dataloader = dict(
    batch_size=train_batch_size_per_gpu,  # Same as training for faster validation
    num_workers=4,
    persistent_workers=True,
    pin_memory=True,
    drop_last=False,
...
work_dir = './work_dirs/wedetect_tiny_tct'

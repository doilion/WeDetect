_base_ = ["./wedetect_tiny_tct_ngc_dev_2gpu.py"]

# Current TCT_NGC dev split after the May 2026 refresh.
# Uses 32 full-name prompts and cached text embeddings, so the text encoder is
# not trained or run online.
train_class_text_path = "data/texts/tct_ngc_fullnames_32.json"
test_class_text_path = train_class_text_path
text_embed_path = "data/texts/tct_ngc_fullnames_32_embeddings_wedetect_tiny.pth"
...
work_dir = "./work_dirs/wedetect_tiny_tct_ngc_dev32_fullnames_1gpu"
